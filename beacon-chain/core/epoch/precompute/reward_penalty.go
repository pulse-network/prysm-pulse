...
func ProcessRewardsAndPenaltiesPrecompute(
	...
	for i := 0; i < numOfVals; i++ {
		...
		validatorBals[i], err = helpers.IncreaseBalanceWithVal(validatorBals[i], attsRewards[i]+proposerRewards[i], true)
		if err != nil {
			return nil, err
		}
...
func attestationDelta(pBal *Balance, sqrtActiveCurrentEpoch *big.Int, v *Validator, prevEpoch, finalizedEpoch primitives.Epoch) (uint64, uint64) {
